...
import { fetchTaskBranch, updateTaskBranch } from 'actions/index';
import { 
...
// 分支机构信息
class TaskBranchOrganInfo extends Component {
    constructor(props) {
        super(props);
    ...
    componentWillMount() {
        this.props.fetchTaskBranch(this.props.params.id);
    }
    ...
    handleClick() {
        ...
        this.props.updateTaskBranch(data);        
...
function mapStateToProps({ task }, { params }) {
    const entities = task.branchEntities;
    return {
...
export default connect(mapStateToProps, { 
    fetchTaskBranch: fetchTaskBranch,
    updateTaskBranch: updateTaskBranch
})(TaskBranchOrganInfo);
